...
## auth
# SUPER_USERS = json.loads( os.environ['DJANGO_TEMPLATE__SUPER_USERS_JSON'] )
...
# TEST_META_DCT = json.loads( os.environ['DJANGO_TEMPLATE__TEST_META_DCT_JSON'] )  # for local-developemnt simulating shib-data
